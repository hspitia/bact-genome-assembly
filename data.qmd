...
Descargaremos cuatro muestras de secuenciación de genoma completo o WGS (del inglés *Whole Genome Sequencing*) del organismo *Helicobacter* *pylori*, para ser ensambladas. Para descagar estas muestras necesitaremos los identificadores (número de acceso o *accession number* en inglés) en la base de datos SRA:
